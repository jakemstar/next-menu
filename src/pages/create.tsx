...
export default function Create() {
    ...
    const ingredientOnSubmit: SubmitHandler<IngredientFormType> = () => {
        ...
        const parsedIngredient = {
            name: ingredientName, 
            amount: ingredientAmount.charAt(0) === "." ? "0".concat(ingredientAmount) : ingredientAmount,
